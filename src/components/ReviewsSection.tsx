...
export const ReviewsSection: React.FC = () => {
  return (
    <section id="reviews" className="py-24 lg:py-40 border-b border-[#E8E2D7] bg-[#FBF9F5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-20 animate-fade-in-up">
          ...
          <div className="mt-10 lg:mt-0 flex items-center gap-8 bg-[#ECE6DC] px-8 py-5 border border-[#E8E2D7] rounded-sm">
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {GOOGLE_REVIEWS.map((review, idx) => (
            <div
              ...
              className="bg-[#F5F1E9] border border-[#E8E2D7] p-10 lg:p-12 rounded-sm flex flex-col justify-between hover:-translate-y-1 transition-transform duration-500 animate-fade-in-up"
            ...
            >
              ...
              {/* Attribution */}
              <div className="pt-6 border-t border-[#D8D1C4] flex items-center justify-between">
                <div>
        ...
        <div className="mt-12 text-center sm:hidden animate-fade-in-up animate-delay-400">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-3 w-full py-4 border border-[#1C1B19] text-[#1C1B19] text-xs uppercase tracking-[0.16em] font-medium rounded-[2px]"
          >
